        ...
        <div className="row justify-content-between align-items-center">
          ...
          <div className="col-lg-3">
            <div className="info wow fadeInUp" data-wow-delay="0.3s">
              <h3 className="fsz-45 fw-600 mb-30"> About </h3>
              <div className="text fsz-15 color-666">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore repudiandae possimus magni atque necessitatibus perspiciatis, facere totam, vero rem quod ipsum unde labore est, aperiam voluptates! Repellendus, praesentium? Commodi, accusamus!
              </div>
              <a
                href="#"
              ...
              >
                <span>
                  See more <i className="small ms-1 ti-arrow-top-right"></i>
                </span>
              </a>
            </div>
          </div>
