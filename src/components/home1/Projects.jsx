...
function Projects() {
  return (
    <section className="tc-projects-style1 align-items-center">
      <div className="container" style={{ overflow: "hidden" }}>
        <div className="title mb-70">
          <h2 className="fsz-45"> Featured Projects </h2>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo voluptatibus corrupti magnam aliquid ipsum ut unde repellat expedita architecto! Maxime dignissimos quam harum praesentium repellendus ducimus aspernatur sint? Iure, nostrum!
        </div>
